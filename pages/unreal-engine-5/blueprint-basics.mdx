...
<Cards>
  <Card title="Blueprint Class" href="#blueprint-class">
    가장 일반적인 타입. 액터, 폰, 캐릭터 등 생성
  </Card>
  <Card title="Level Blueprint" href="#level-blueprint">
    특정 레벨에만 적용되는 로직
  </Card>
  <Card title="Widget Blueprint" href="#widget-blueprint">
    UI 요소 제작용
  </Card>
  <Card title="Animation Blueprint" href="#animation-blueprint">
    캐릭터 애니메이션 제어
  </Card>
</Cards>
...
<Cards>
  <Card title="Direct Reference" href="#direct">
    다른 블루프린트 직접 참조
  </Card>
  <Card title="Cast" href="#cast">
    특정 클래스로 변환
  </Card>
  <Card title="Interface" href="#interface">
    인터페이스를 통한 통신
  </Card>
  <Card title="Event Dispatcher" href="#dispatcher">
    이벤트 기반 통신
  </Card>
</Cards>
