...
export const MovingPlatformBlueprint = dynamic(
  () => import('../../../components/UE5BlueprintExamples').then(mod => ({ default: mod.MovingPlatformBlueprint })),
  { ssr: false }
)

export const SplineMovementBlueprint = dynamic(
  () => import('../../../components/UE5BlueprintExamples').then(mod => ({ default: mod.SplineMovementBlueprint })),
  { ssr: false }
)
