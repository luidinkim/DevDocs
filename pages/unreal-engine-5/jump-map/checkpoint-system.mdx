...
export const CheckpointBlueprint = dynamic(
  () => import('../../../components/UE5BlueprintExamples').then(mod => ({ default: mod.CheckpointBlueprint })),
  { ssr: false }
)

export const RespawnSystemBlueprint = dynamic(
  () => import('../../../components/UE5BlueprintExamples').then(mod => ({ default: mod.RespawnSystemBlueprint })),
  { ssr: false }
)
