...
<UE5BlueprintLayout algorithm="smart">
  {() => {
    ...
    const nodes = [
        ...
        data: {
          render: () => (
            <GetNode
              title="Jump Force"
              outputs={[
                { name: 'Jump Force', type: 'float', value: '2000' }
              ]}
            />
          )
        }
          ...
          render: () => (
            <FunctionNode
              ...
              inputs={[
                { name: '', type: 'exec' },
                { name: 'Target', type: 'object' },
                { name: 'Launch Velocity', type: 'vector' },
                { name: 'XY Override', type: 'boolean' },
                { name: 'Z Override', type: 'boolean' }
              ]}
              outputs={[
                { name: '', type: 'exec' }
              ]}
      ...
      {
        id: 'handleReactivation',
        type: 'custom',
        position: { x: 1650, y: 0 },
        data: {
          render: () => (
            <FunctionNode
              title="Handle Reactivation"
              subtitle="Custom Event"
              inputs={[
                { name: '', type: 'exec' }
              ]}
    ...
    const edges = [
      { id: 'e1', source: 'overlap', target: 'branch1', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'exec' },
      { id: 'e2', source: 'isActive', target: 'branch1', sourceHandle: 'output-0', targetHandle: 'input-1', type: 'data' },
      { id: 'e3', source: 'branch1', target: 'cast', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'exec' },
      { id: 'e4', source: 'overlap', target: 'cast', sourceHandle: 'output-1', targetHandle: 'input-1', type: 'data' },
      { id: 'e5', source: 'cast', target: 'launch', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'exec' },
      { id: 'e6', source: 'cast', target: 'launch', sourceHandle: 'output-2', targetHandle: 'input-1', type: 'data' },
      { id: 'e7', source: 'multiply', target: 'launch', sourceHandle: 'output-0', targetHandle: 'input-2', type: 'data' },
      { id: 'e8', source: 'getDirection', target: 'multiply', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'data' },
      { id: 'e9', source: 'jumpForce', target: 'multiply', sourceHandle: 'output-0', targetHandle: 'input-1', type: 'data' },
      { id: 'e10', source: 'launch', target: 'playEffects', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'exec' },
      { id: 'e11', source: 'playEffects', target: 'handleReactivation', sourceHandle: 'output-0', targetHandle: 'input-0', type: 'exec' }
    ];
