...
Event: On Component Begin Overlap (BoxCollision)
├── Cast to Character
├── Get Game Mode → Cast to BP_JumpMapGameMode
├── Check if Game Not Started
│   ├── True: Start Game Sequence
│   │   ├── Call GM->StartGame()
│   │   ├── Play Start Sound
│   │   ├── Spawn Start Particles
│   │   ├── Flash UI (Game Started!)
│   │   └── Disable Further Triggers
│   └── False: Do Nothing
└── Optional: Teleport to Checkpoint
</Code>
