...
export const PlayerControllerInput = dynamic(
  () => import('../../../components/UE5JumpMapComponents').then(mod => ({ default: mod.PlayerControllerInput })),
  { ssr: false }
)
...
<Callout type="info" emoji="🎮">
  **Enhanced Input System**
  - UE5의 새로운 입력 시스템을 사용하여 더 유연한 입력 처리가 가능합니다.
  - 위 블루프린트는 점프 액션 처리의 예시를 보여줍니다.
</Callout>
