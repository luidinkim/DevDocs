...
const EnhancedMermaid = dynamic(() => import('../../components/EnhancedMermaid'), { 
  ssr: false,
...
### 향상된 인터랙티브 버전
<EnhancedMermaid 
  title="SuperClaude 전체 아키텍처 - Interactive"
  description="마우스를 올려 상세 정보를 확인하고, 줌 기능을 사용해보세요"
  enableZoom={true}
  enableExport={true}
  theme="modern"
  chart={`
...
<InteractiveDiagram
  type="flowchart"
  title="SuperClaude 플로우차트 - 완전 인터랙티브"
  data={{
    nodes: [
      { id: 'input', label: '사용자 입력', x: 300, y: 50, icon: '👤', connections: ['parser'] },
      { id: 'parser', label: '명령어 파서', x: 300, y: 150, icon: '⚙️', connections: ['analyzer', 'complexity'] },
      { id: 'analyzer', label: '컨텍스트 분석', x: 150, y: 250, icon: '🔍', connections: ['persona'] },
      { id: 'complexity', label: '복잡도 평가', x: 450, y: 250, icon: '📊', connections: ['mcp'] },
      { id: 'persona', label: '페르소나 선택', x: 150, y: 350, icon: '🎭', connections: ['execute'] },
      { id: 'mcp', label: 'MCP 서버', x: 450, y: 350, icon: '🖥️', connections: ['execute'] },
      { id: 'execute', label: '실행 엔진', x: 300, y: 450, icon: '⚡', connections: ['output'] },
      { id: 'output', label: '결과 출력', x: 300, y: 550, icon: '✅', connections: [] }
    ]
  }}
/>
...
**새로운 기능:**
- 🔍 **줌 인/아웃**: 다이어그램을 확대/축소할 수 있습니다
- 💾 **내보내기**: SVG 또는 PNG 형식으로 다운로드 가능
- 🎨 **테마 지원**: 라이트/다크 모드 자동 전환
- 🖱️ **인터랙티브**: 노드를 클릭하여 상세 정보 확인
- 📱 **반응형**: 모바일에서도 완벽하게 작동
</Callout>