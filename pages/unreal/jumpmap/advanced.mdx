...
import { Save, Trophy, Zap, Settings } from 'lucide-react'
...
<Cards>
  <Card title="Classic Mode" icon={<Trophy />}>
    기본 점프맵 게임플레이
  </Card>
  <Card title="Time Attack" icon={<Zap />}>
    시간 제한 속도 도전
  </Card>
  <Card title="Survival Mode" icon={<Settings />}>
    끝없는 도전, 점진적 난이도
  </Card>
  <Card title="Multiplayer Race" icon={<Save />}>
    실시간 멀티플레이어 경쟁
  </Card>
</Cards>
